...
const ChatWindow = ({ currentUser, messages = [], onSendMessage }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl border dark:border-gray-700 flex flex-col h-full">
            <div className="p-4 border-b dark:border-gray-700">
                <h3 className="font-bold text-lg text-center">Chat with Us</h3>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-4 border-t dark:border-gray-700 flex items-center">
                <input type="file" id="floating-chat-upload" className="hidden" onChange={handleMediaUpload} accept="image/*,video/*" />
                <label htmlFor="floating-chat-upload" className="mr-4 text-gray-500 dark:text-gray-400 hover:text-teal-500 dark:hover:text-teal-400 p-2 cursor-pointer">
                    {icons.attach}
                </label>
                <input 
                    type="text" 
